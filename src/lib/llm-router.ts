...
- If the target time is in the future, you MUST recommend a future departure time (e.g., 5:30 PM or 5:45 PM) so they arrive around their target time. DO NOT recommend leaving "Now" if the target time is in the future. Ensure all departure and arrival times in your explanation and JSON values are in clean 12-hour format (e.g., 6:20 PM, not 17:40 (6:20 PM) or 17:40).
