...
const FeedbackSlider = React.forwardRef<HTMLDivElement, FeedbackSliderProps>(
  ({ className, ...props }, ref) => {
    ...
    return (
      <motion.div
        ref={ref}
        className={`relative flex h-full w-full items-center justify-center overflow-hidden rounded-3xl shadow-2xl ${className}`}
      ...
      >
        <div className="flex h-full w-full max-w-[400px] flex-col items-center justify-center p-4 py-8 md:py-12 scale-90 md:scale-100">
          <motion.h3
            ...
            transition={transition}
          >
            How was your commute experience?
          </motion.h3>
          ...
          <div className="w-full">
            <div className="relative flex w-full items-center justify-between">
              ...
              />
              <motion.div
                className="absolute z-[3] flex h-10 w-10 -translate-x-1/2 items-center justify-center rounded-full p-2 pointer-events-none"
                animate={{
