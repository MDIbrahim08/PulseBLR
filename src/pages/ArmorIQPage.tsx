...
import ArmorIQDashboard from '../components/ArmorIQDashboard';
    ...
    <div className="min-h-screen w-full bg-slate-950 font-sans text-white">
      ...
      <header className="w-full px-[120px] py-4 flex justify-between items-center bg-slate-950 border-b border-white/10 relative z-50">
        ...
        <nav className="flex items-center gap-8 font-schibsted font-medium text-[15px] tracking-[-0.2px] text-white/60">
           ...
           <button onClick={() => navigate('/smart-pivot')} className="hover:text-white/80 transition-colors">
             Smart Pivot
           </button>
           <button onClick={() => navigate('/armor-iq')} className="text-white relative">
             ArmorIQ
